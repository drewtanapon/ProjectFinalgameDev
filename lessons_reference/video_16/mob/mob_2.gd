...
@onready var Minion_model = %Skeleton_Minion
...
func _physics_process(delta):
	...
	Minion_model.rotation.y = Vector3.FORWARD.signed_angle_to(direction, Vector3.UP) + PI
...
func take_damage():
	...
	if health == 0:
		ko_sound.play()
		Minion_model.animation_tree.active = false
		Minion_model.die()
